 ...
 * @author HP
 */
public class AppInformation extends javax.swing.JDialog {

    /**
     * Creates new form AppInformation
     */
    public AppInformation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Tugas Akhir - S1 Informatika");

        subtitle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        subtitle.setText("Universitas Muhammadiyah Tangerang");
        ...
        kelompok.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "NPM : 1455201520", "Nama : Faisal Fahmi Al Hasani" };
        ...
        bodyLayout.setHorizontalGroup(
            ...
            .addComponent(header, javax.swing.GroupLayout.DEFAULT_SIZE, 598, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AppInformation dialog = new AppInformation(new javax.swing.JFrame(), true);
